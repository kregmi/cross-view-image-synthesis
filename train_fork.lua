...
opt = {
   ...
   save_display_freq = 13750,    -- save the current display of results every save_display_freq_iterations
...
local real_Bs = torch.Tensor(opt.batchSize, output_nc_seg, opt.fineSize, opt.fineSize)   -- real segmentation image view 2
local fake_B = torch.Tensor(opt.batchSize, output_nc, opt.fineSize, opt.fineSize)    -- generated image view 2
local fake_Bs = torch.Tensor(opt.batchSize, output_nc_seg, opt.fineSize, opt.fineSize)   -- fake segmentation image view 2
