-- usage: DATA_ROOT=/path/to/data/ name=expt1 which_direction=a2g th test.lua
--
...
opt = {
    DATA_ROOT = '/path/to/test/data/folder',           -- path to images (should have subfolders 'train', 'val', etc)
...
for n=1,math.floor(opt.how_many/opt.batchSize) do
    ...
    -- filepaths = TableConcat(filepaths, filepaths_curr)       -- used for making webpage
end
